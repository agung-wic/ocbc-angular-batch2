...
describe('Contoh1Component', () => {
  ...
  it(`should have a title 'Ini adalah contoh judul'`, (()=>{
    fixture = TestBed.createComponent(Contoh1Component);
    component = fixture.debugElement.componentInstance;
    expect(component.title).toEqual('Ini adalah contoh judul');
  }));
  ...
  it('should render title', ()=>{
    ...
    expect(compiled.querySelector('h1.title')?.textContent).toContain('Ini adalah contoh judul');
  });
